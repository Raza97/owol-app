...
const CookbookHome = () => {
        ...
        return (
            <View style={styles.optionsList}>
                <View style={styles.optionContainer}>
                    <Text style={[styles.optionText, { color: theme == 'light' ? '#cc' : Colors.dark.text }]}>Create new recipe</Text>
                    <TouchableOpacity style={styles.addButton} onPress={() => { nav.navigate('newrecipe'); setIsSheetVisible(false) }}>
                        <MaterialIcons name="add" size={20} color="white" />
                    </TouchableOpacity>
                </View>
                <View style={styles.optionContainer}>
                    <Text style={[styles.optionText, { color: theme == 'light' ? '#cc' : Colors.dark.text }]}>Create new collection</Text>
                    <TouchableOpacity onPress={() => { nav.navigate('newcollection'); setIsSheetVisible(false) }} style={styles.addButton}>
                        <MaterialIcons name="add" size={20} color="white" />
                    </TouchableOpacity>
                </View>
                <View style={styles.optionContainer}>
                    <Text style={[styles.optionText, { color: theme == 'light' ? '#cc' : Colors.dark.text }]}>Create new lesson</Text>
    ...
    return (
        <SafeAreaView style={[styles.container, { backgroundColor: theme == 'light' ? 'white' : Colors.dark.background }]}>
                ...
                <View style={styles.sectionContainer}>
                    ...
                    <View style={styles.recipesContainer}>
                        <RecipeCard
                            ...
                            rating={4.9}
                            likes={120}
                            imageSource={require('../../../../assets/images/earnercookbook5.jpg')} // Replace with your image
                        />
                        <RecipeCard
                            title="Porridge"
                            rating={4.5}
                        ...
                        <RecipeCard
                            ...
                            rating={4.2}
                            likes={120}
                            imageSource={require('../../../../assets/images/earnercookbook6.jpg')} // Replace with your image
                        />
                        <RecipeCard
                            title="Porridge"
                            rating={4.5}
            ...
            <EarnerBottomBar where={'cookbook'} />
        </SafeAreaView>
    );
};
...
const styles = StyleSheet.create({
    ...
    addButton: {
        marginLeft: 10,
        backgroundColor: '#79B939', // Green background
        borderRadius: 30
    },
    optionsList: {
        marginTop: 10,
    ...
    floatingButton: {
        ...
        bottom: 100,
        right: 20,
        backgroundColor: '#79B939', // Blue background
        borderRadius: 50,
        padding: 10,
        shadowColor: '#000',
