...
const KitchenSpaceInventory = () => {
            ...
            <View style={styles.header}>
                ...
                {onboardingSteps !== 1 ?
                    <TouchableOpacity onPress={handleBack}>
                        <MaterialIcons name="chevron-left" size={30} color="#13100D" />
                    </TouchableOpacity>
                    :
                    <TouchableOpacity onPress={() => nav.goBack()}>
                        <MaterialIcons name="close" size={25} color="#13100D" />
                    </TouchableOpacity>}


                {onboardingSteps == 1 && <Text style={{ fontSize: 18, fontWeight: 'bold', color: 'black' }}>Inventory</Text>}
                {onboardingSteps == 2 &&
                ...
                {onboardingSteps == 4 && <Text style={{ fontSize: 18, fontWeight: 'bold', color: 'black' }}>Inventory</Text>}

                {onboardingSteps === 1 && <TouchableOpacity>
                    <MaterialIcons name="menu" size={25} color="#13100D" />
                </TouchableOpacity>}
    ...
    const step1 = () => {
        return (
            <ScrollView style={{ marginHorizontal: 20 }} showsVerticalScrollIndicator={false} >
                <View style={[styles.sectionContainer, { borderRadius: 16, backgroundColor: '#13100D', padding: 10 }]}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                        <View style={[styles.insideSmallDetailViews, { backgroundColor: '#5C5D58' }]}>
                            <Text style={{ fontSize: 12, color: 'white', textAlign: 'center' }}>9 expiring soon</Text>
                        </View>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 15 }}>
                    <View style={{ padding: 5, backgroundColor: '#E8EAE3', borderRadius: 30, }}>
                        <Text style={{ fontSize: 15, fontWeight: 'bold' }}>Pantry {'(20)'}</Text>
                    </View>
                    <View style={{ padding: 10, backgroundColor: 'white', borderRadius: 30, marginLeft: 10 }}>
                        <Text style={{ fontSize: 15, color: 'black' }}>Fridge {'(20)'}</Text>
                    </View>
                    <View style={{ padding: 10, backgroundColor: 'white', borderRadius: 30, marginLeft: 10 }}>
                        <Text style={{ fontSize: 15, color: 'black' }}>Freezer {'(20)'}</Text>
                    </View>

                </View>

                <View style={{ marginTop: 15 }}>
                    <Text style={{ fontSize: 14, color: '#83867C', }}>Fruits - 4</Text>
                    <View style={styles.itemContainer}>
                        <View style={styles.ingredientImageContainer}>
                            <Image source={require('../../../../../assets/images/banana.jpg')} resizeMode='cover' style={styles.ingredientImage} />
                            <Text style={[styles.ingredientName, { fontSize: 17 }]}>Banana</Text>
                        </View>
                        <View style={{ flexDirection: 'row', alignItems: 'center', }}>
                ...
                <View style={{ marginTop: 15 }}>
                    <Text style={{ fontSize: 14, color: '#83867C', }}>Category - 4</Text>
                    <View style={styles.itemContainer}>
                        <View style={styles.ingredientImageContainer}>
                            <Image source={require('../../../../../assets/images/banana.jpg')} resizeMode='cover' style={styles.ingredientImage} />
                            <Text style={[styles.ingredientName, { fontSize: 17 }]}>Banana</Text>
    ...
    const step4 = () => {
        return (
            <ScrollView style={{ marginHorizontal: 20 }} showsVerticalScrollIndicator={false} >
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 15 }}>
                    <View style={{ padding: 5, backgroundColor: '#E8EAE3', borderRadius: 30, }}>
                        <Text style={{ fontSize: 15, fontWeight: 'bold' }}>Pantry</Text>
                    </View>
                    <View style={{ padding: 10, backgroundColor: 'white', borderRadius: 30, marginLeft: 10 }}>
                        <Text style={{ fontSize: 15, color: 'black' }}>Fridge</Text>
                    </View>
                    <View style={{ padding: 10, backgroundColor: 'white', borderRadius: 30, marginLeft: 10 }}>
                        <Text style={{ fontSize: 15, color: 'black' }}>Freezer</Text>
                    </View>
                    <View style={{ padding: 10, backgroundColor: '#A6A8A0', borderRadius: 30, marginLeft: 10, padding: 2, }}>
                ...
                <View style={{ marginTop: 15 }}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                        <Text style={{ fontSize: 14, color: '#83867C', }}>Fruits</Text>
                        <View style={{ flexDirection: 'row', alignItems: "center" }}>
                            <Text style={
                                {
                                    fontSize: 13,
    ...
    return (
        <SafeAreaView style={[styles.container, { backgroundColor: (onboardingSteps !== 1 && onboardingSteps !== 4) ? Colors.dark.background : 'white' }]}>
            {header()}
            {onboardingSteps === 1 && step1()}
            {onboardingSteps === 2 && step2()}
            {onboardingSteps === 3 && step3()}
            {onboardingSteps === 4 && step4()}
            {(!isSheetVisible && onboardingSteps !== 2 && onboardingSteps !== 3) && <TouchableOpacity onPress={() => setOnboardingSteps(onboardingSteps + 1)}
...
export default KitchenSpaceInventory;