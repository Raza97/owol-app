        ...
        return (
            <View style={styles.header}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <Text style={{ fontSize: 18, fontWeight: 'bold', color: 'black', marginLeft: 5 }}>Barcode Scan</Text>
                </View>
        ...
        return (
            <View style={{ marginHorizontal: 20 }}>
                ...
                <View style={{ marginTop: 20 }}>
                    <Text style={{ fontSize: 18, fontWeight: 'bold', marginTop: 20, color: Colors.dark.background, textAlign: 'center' }}>Tap to scan</Text>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '100%' }}>
                        <TouchableOpacity onPress={() => {
                            nav.navigate('aiscan')
                        }} style={{ padding: 20, borderRadius: 40, marginTop: 20, alignSelf: 'center' }} >
                        ...
                        <TouchableOpacity onPress={() => {
                            ...
                            nav.goBack()
                        }} style={{ backgroundColor: Colors.dark.background, padding: 20, borderRadius: 40, marginTop: 20, alignSelf: 'center' }} >
                            <MaterialIcons name='qr-code-scanner' color={'white'} size={30} />
                        </TouchableOpacity>

                        <TouchableOpacity style={{ padding: 20, borderRadius: 40, marginTop: 20, alignSelf: 'center' }} >
