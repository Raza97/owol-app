    ...
    return (
        <SafeAreaView style={[styles.container, { backgroundColor: theme == 'light' ? Colors.light.background : Colors.dark.background }]}>
            ...
            <TouchableOpacity style={styles.backButtonContainer} onPress={() => nav.goBack()}>
                <View style={{ alignItems: 'center', backgroundColor: ggStyles.greenBg.backgroundColor, borderRadius: 30 }}>
                    <MaterialIcons name="chevron-left" size={30} color={Colors.dark.btn} />
                </View>
            </TouchableOpacity>

            <Typhography size={24} style={styles.heading}>Now you are ready to get to know the app better</Typhography>
            ...
            <View style={styles.imageContainer}>
                ...
                {/* {theme == 'light' &&
                    <Image source={require('../../../../assets/images/onboardingswirl.png')} style={{ position: 'absolute', zIndex: -10, top:-60 }} />
                } */}
...
export default EarnerAppOnboardingStarter;